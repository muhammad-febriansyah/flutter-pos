...
import 'package:pos/app/data/models/detail_penjualan.dart'; // Make sure this path is correct
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Obx(() {
          ...
          // Extract produk_id and transaction_id for the rating page
          // Assuming you want to rate the first product in the list for this transaction.
          // If a transaction can have multiple products that need individual ratings,
          // you'd need a different flow (e.g., a list of items to rate).
          final int productIdForRating = // PERBAIKAN: Menggunakan productId
              purchasedItems.isNotEmpty ? purchasedItems.first.produkId : 0;
          final int transactionIdForRating =
              dataPenjualanUtama
                  .id; // Assuming `id` of Penjualan is the transaction_id
          final String
          productNameForRating = // PERBAIKAN: Menggunakan productName
              purchasedItems.isNotEmpty
                  ? purchasedItems.first.produk.namaProduk
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Obx(() {
                              final isPaid =
                                  controller.detailPenjualanList.value?.any(
                                    (e) => e.penjualan.status == 'paid',
                                  ) ??
                                  false;

                              if (!isPaid) {
                                return const SizedBox(); // sembunyikan tombol jika belum paid
                              }
                              ...
                              return ElevatedButton(
                                onPressed: () {
                                  Get.offAllNamed(
                                    Routes.RATING,
                                    arguments: {
                                      'product_id': productIdForRating,
                                      'transaction_id': transactionIdForRating,
                                      'product_name': productNameForRating,
                                    },
                                  );
                                },
                                style: ElevatedButton.styleFrom(
